...
filestore_backend = env('SENTRY_FILESTORE_BACKEND').lower() or 'filesystem'
SENTRY_OPTIONS['filestore.backend'] = filestore_backend
if filestore_backend == 's3':
    ...
    SENTRY_OPTIONS['filestore.options'] = {
        'location': env('SENTRY_FILESTORE_DIR') or '/tmp/sentry-files',
    }
